...
#GSE20168
GSE28894.seq.data <- prepseq(id="GSE28894", study_type="microarray", type=1, anno="SYMBOL", anno_col="ID_REF", cts_col="expected_count",
                              is.platform=FALSE, plat="GPL96", unique.id="itle", ctrl_id="Control",dis_id="PD", filetype="txt",
                              mypath =  paste0(workPath,"transcriptomics/PD/GSE28894/"))

#GSE43490
GSE43490.seq.data <- prepseq(id="GSE43490", study_type="microarray", type=1, anno="SYMBOL", anno_col="ID_REF", cts_col="expected_count",
                              is.platform=FALSE, plat="GPL96", unique.id="itle", ctrl_id="control",dis_id="Braak", filetype="txt",
                              mypath =  paste0(workPath,"transcriptomics/PD/GSE43490/"))

#GSE49036
GSE49036.seq.data <- prepseq(id="GSE49036", study_type="microarray", type=1, anno="SYMBOL", anno_col="ID_REF", cts_col="expected_count",
                              is.platform=FALSE, plat="GPL96", unique.id="itle", ctrl_id="Control",dis_id="Braak", filetype="txt",
                              mypath =  paste0(workPath,"transcriptomics/PD/GSE49036/"))

#GSE68719
GSE68719.seq.data <- prepseq(id="GSE68719", study_type="RNAseq",type=2, anno="ENSEMBL",anno_col="ENSEMBL", cts_col="count", 
                              filetype="tsv",mypath= paste0(workPath,"transcriptomics/PD/GSE68719/"))

#GSE120746
GSE120746.seq.data <- prepseq(id="GSE120746", study_type="RNAseq",type=4, anno="ENSEMBL",anno_col="ENSEMBL", cts_col="count", 
                              filetype="tsv",mypath= paste0(workPath,"transcriptomics/PD/GSE120746/"))


#GSE135743
GSE135743.seq.data <- prepseq(id="GSE135743", study_type="RNAseq",type=1, anno="ENSEMBL",anno_col="gene_id", cts_col="expected_count", 
                              filetype="txt",mypath= paste0(workPath,"transcriptomics/PD/GSE135743/"))

#GSE172409
GSE172409.seq.data <- prepseq(id="GSE172409", study_type="RNAseq",type=2, anno="SYMBOL",anno_col="SYMBOL", cts_col="expected_count", 
                              filetype="txt",mypath= paste0(workPath,"transcriptomics/PD/GSE172409/"))
